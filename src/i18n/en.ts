...
export const en = {
  ...
  'storage.usageTitle': 'Local disk',
  'storage.usageAssets': 'Assets {size} · {count} objects',
  'storage.usageDisk': 'Disk used {used} of {total}',
  'storage.usageFree': '{free} free',
  'storage.usageLegendAssets': 'Assets',
  'storage.usageLegendOther': 'Other files',
  'storage.usageLow': 'Less than 10% of the disk is left.',
  'storage.backupSection': 'Backup',
  ...
  'storage.backupStatus': 'Replication',
  'storage.backupStats':
    '{replicated} copied · {failed} failed · {pending} queued',
  'storage.backupSyncing': 'Syncing…',
  'storage.backupLastSync': 'Last full sync {date}, {count} copied',
  'storage.backupNeverSynced': 'No full sync has finished yet',
  'storage.backupLastError': 'Last error ({date}): {error}',
  'storage.backupSync': 'Sync now',
  'storage.backupSaveFirst': 'Save the backup before syncing it.',
  'storage.errorSync': 'Unable to start the backup sync',
  ...
  'admin.navErrorLogs': 'Error logs',
  'errorLogs.title': 'Error logs',
  'errorLogs.note':
    'Warnings and errors the gateway logged, newest first. Search a request ID from an error response to find what went wrong.',
  'errorLogs.last24h': 'Last 24 hours',
  'errorLogs.countError': '{count} errors',
  'errorLogs.countWarn': '{count} warnings',
  'errorLogs.levelLabel': 'Level',
  'errorLogs.levelAll': 'All levels',
  'errorLogs.levelError': 'Error',
  'errorLogs.levelWarn': 'Warning',
  'errorLogs.searchLabel': 'Search',
  'errorLogs.searchPlaceholder': 'Message, request ID, source, or field',
  'errorLogs.search': 'Search',
  'errorLogs.refresh': 'Refresh',
  'errorLogs.clear': 'Clear all',
  'errorLogs.columnTime': 'Time',
  'errorLogs.columnLevel': 'Level',
  'errorLogs.columnMessage': 'Message',
  'errorLogs.columnRequest': 'Request ID',
  'errorLogs.loading': 'Loading error logs…',
  'errorLogs.empty': 'No error logs',
  'errorLogs.emptyNote': 'Nothing has been logged that matches this filter.',
  'errorLogs.errorLoad': 'Unable to load the error logs',
  'errorLogs.loadMore': 'Load more',
  'errorLogs.source': 'Source',
  'errorLogs.fields': 'Fields',
  'errorLogs.stack': 'Stack',
  'errorLogs.noFields': 'No structured fields.',
  'errorLogs.filterRequest': 'Show this request',
  'errorLogs.clearTitle': 'Clear every error log?',
